...
(function (global) {
  ...
  function applyPrintSetup(ws, lastRow, lastCol) {
    // Marge de 2 lignes et 2 colonnes entre le tableau et le contour de la zone d'impression,
    // pour que celui-ci ne colle pas directement aux bordures du tableau.
